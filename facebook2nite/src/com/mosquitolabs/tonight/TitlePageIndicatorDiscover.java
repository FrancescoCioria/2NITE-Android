 ...
 * are also scrolled.
 */
public class TitlePageIndicatorDiscover extends View implements
		PageIndicatorDiscover {
	/**
	...
	private DiscoverActivity parentActivity; // asdf
	...
	public TitlePageIndicatorDiscover(Context context) {
		this(context, null);
	}

	public TitlePageIndicatorDiscover(Context context, AttributeSet attrs) {
	...
	public TitlePageIndicatorDiscover(Context context, AttributeSet attrs,
		...
		mFooterLineHeight = 0;// a.getDimension(R.styleable.TitlePageIndicator_footerLineHeight,
		...
		mFooterIndicatorHeight = 0;// a.getDimension(R.styleable.TitlePageIndicator_footerIndicatorHeight,
		...
		mFooterPadding = 13;// a.getDimension(R.styleable.TitlePageIndicator_footerPadding,
							// defaultFooterPadding);
		mTopPadding = 5;// a.getDimension(R.styleable.TitlePageIndicator_topPadding,
						// defaultTopPadding);
		mTitlePadding = a.getDimension(
				R.styleable.TitlePageIndicator_titlePadding,
				defaultTitlePadding) + 50;// modificato (+150)
		mClipPadding = a.getDimension(
				R.styleable.TitlePageIndicator_clipPadding, defaultClipPadding);
		mColorSelected = Color.WHITE;// Color.rgb(235, 163, 91);//
										// a.getColor(R.styleable.TitlePageIndicator_selectedColor,
										// defaultSelectedColor);
										// //era
										// defaultSelectedColor
		mColorText = Color.WHITE; // Color.rgb(235, 163, 91);// Color.rgb(217,
									// 117,
									// 0);//a.getColor(R.styleable.TitlePageIndicator_textColor,
									// defaultTextColor);
		...
		mPaintFooterLine.setColor(Color.TRANSPARENT); // era footerColor
		mPaintFooterIndicator.setStyle(Paint.Style.FILL_AND_STROKE);
		mPaintFooterIndicator.setColor(Color.TRANSPARENT); // era footerColor
	...
	@Override
	public void setViewPager(ViewPager view, DiscoverActivity activity) {// ho
																			// aggiunto
																			// Activity
		parentActivity = activity;// fatto io
	...
	public void setViewPager(ViewPager view, int initialPosition) {
		setViewPager(view, parentActivity); // aggiunto parentActivity
